...
- [四、购物车模块 (Cart)](#四购物车模块-cart)
  ...
  - [3.2 更新商品数量](#32-更新商品数量)
  - [3.3 设置选中状态](#33-设置选中状态)
  - [3.4 全选/取消全选](#34-全选取消全选)
  - [3.5 移除商品](#35-移除商品)
  - [3.6 清空购物车](#36-清空购物车)
  - [3.7 清空已选商品](#37-清空已选商品)
  - [3.8 获取购物车列表](#38-获取购物车列表)
  - [3.9 获取已选商品](#39-获取已选商品)
  - [3.10 获取购物车概要](#310-获取购物车概要)
- [五、订单模块 (Order)](#五订单模块-order)
  - [4.1 创建订单](#41-创建订单)
  - [4.2 从购物车结算创建订单](#42-从购物车结算创建订单)
  - [4.3 获取订单详情](#43-获取订单详情)
  - [4.4 获取订单列表](#44-获取订单列表)
  - [4.5 获取订单列表（带商品明细）](#45-获取订单列表带商品明细)
  - [4.6 商家分页查询店铺订单列表](#46-商家分页查询店铺订单列表)
  - [4.7 管理员分页查询全部订单列表](#47-管理员分页查询全部订单列表)
  - [4.8 管理员查询订单详情](#48-管理员查询订单详情)
  - [4.9 商家查询订单详情](#49-商家查询订单详情)
  - [4.11 取消订单](#411-取消订单)
  - [4.12 支付订单](#412-支付订单)
  - [4.13 批量付款](#413-批量付款)
  - [4.14 发货](#414-发货)
  - [4.14 确认收货](#414-确认收货)
  - [4.15 删除订单（逻辑删除）](#415-删除订单逻辑删除)
  - [4.17 获取订单状态描述](#417-获取订单状态描述)
  - [4.18 获取支付状态描述](#418-获取支付状态描述)
  - [4.19 订单超时自动取消（后台定时任务）](#419-订单超时自动取消后台定时任务)
  - [4.20 管理员强制取消订单](#420-管理员强制取消订单)
  - [4.20 管理员调整订单金额](#420-管理员调整订单金额)
  - [4.21 用户申请退款](#421-用户申请退款)
  - [4.22 用户取消退款申请](#422-用户取消退款申请)
  - [4.24 管理员审核通过退款](#424-管理员审核通过退款)
  - [4.25 管理员拒接退款](#425-管理员拒接退款)
  - [4.26 查询退款进度](#426-查询退款进度)
- [六、发货记录模块 (Delivery)](#六发货记录模块-delivery)
  - [5.1 创建发货记录](#51-创建发货记录)
  - [5.2 签收发货记录](#52-签收发货记录)
  - [5.3 标记物流异常](#53-标记物流异常)
  - [5.4 获取订单发货记录](#54-获取订单发货记录)
  - [5.5 根据物流单号查询](#55-根据物流单号查询)
  - [5.6 根据状态查询](#56-根据状态查询)
  - [5.7 获取发货状态描述](#57-获取发货状态描述)
- [七、物流公司模块 (Logistics)](#七物流公司模块-logistics)
  - [6.1 获取启用的物流公司列表](#61-获取启用的物流公司列表)
  - [6.2 获取物流公司详情](#62-获取物流公司详情)
  - [6.3 根据代码获取物流公司](#63-根据代码获取物流公司)
  - [6.4 分页获取物流公司列表](#64-分页获取物流公司列表)
  - [6.5 新增物流公司](#65-新增物流公司)
  - [6.6 更新物流公司](#66-更新物流公司)
  - [6.7 删除物流公司](#67-删除物流公司)
  - [6.8 启用/禁用物流公司](#68-启用禁用物流公司)
- [八、商品模块 (Spu)](#八商品模块-spu)
  - [7.1 新增商品](#71-新增商品)
  - [7.2 更新商品](#72-更新商品)
  - [7.3 删除商品（逻辑删除）](#73-删除商品逻辑删除)
  - [7.4 上架商品](#74-上架商品)
  - [7.5 下架商品](#75-下架商品)
  - [7.6 恢复商品](#76-恢复商品)
  - [7.7 获取商品详情](#77-获取商品详情)
  - [7.8 获取商品列表](#78-获取商品列表)
  - [7.9 根据商家ID获取商品列表](#79-根据商家id获取商品列表)
  - [7.10 根据商家ID分页获取商品列表](#710-根据商家id分页获取商品列表)
  - [7.11 【运营管理员】分页获取全部商品列表](#711-运营管理员分页获取全部商品列表)
  - [7.12 分页获取商品列表](#712-分页获取商品列表)
- [九、SKU模块 (Sku)](#九sku模块-sku)
  - [8.1 新增SKU](#81-新增sku)
  - [8.2 批量新增SKU](#82-批量新增sku)
  - [8.3 更新SKU](#83-更新sku)
  - [8.4 删除SKU](#84-删除sku)
  - [8.5 删除SPU下所有SKU](#85-删除spu下所有sku)
  - [8.6 启用SKU](#86-启用sku)
  - [8.7 禁用SKU](#87-禁用sku)
  - [8.8 更新库存](#88-更新库存)
  - [8.9 扣减库存](#89-扣减库存)
  - [8.10 获取SKU详情](#810-获取sku详情)
  - [8.11 获取SKU列表](#811-获取sku列表)
  - [8.12 分页获取SKU列表](#812-分页获取sku列表)
  - [8.13 获取SPU最低价](#813-获取spu最低价)
  - [8.14 获取SPU总库存](#814-获取spu总库存)
  - [8.15 获取SKU列表（含属性）](#815-获取sku列表含属性)
  - [8.16 获取SKU详情（含属性）](#816-获取sku详情含属性)
- [十、品牌模块 (Brand)](#十品牌模块-brand)
  - [9.1 新增品牌](#91-新增品牌)
  - [9.2 更新品牌](#92-更新品牌)
  - [9.3 删除品牌](#93-删除品牌)
  - [9.4 获取品牌详情](#94-获取品牌详情)
  - [9.5 获取品牌列表](#95-获取品牌列表)
  - [9.6 分页获取品牌列表](#96-分页获取品牌列表)
  - [9.7 根据状态获取品牌](#97-根据状态获取品牌)
  - [9.8 搜索品牌](#98-搜索品牌)
  - [9.9 按排序获取品牌](#99-按排序获取品牌)
- [十一、分类模块 (Category)](#十一分类模块-category)
  - [10.1 新增分类](#101-新增分类)
  - [10.2 更新分类](#102-更新分类)
  - [10.3 删除分类](#103-删除分类)
  - [10.4 获取分类详情](#104-获取分类详情)
  - [10.5 获取分类列表](#105-获取分类列表)
  - [10.6 分页获取分类列表](#106-分页获取分类列表)
  - [10.7 获取分类树形结构](#107-获取分类树形结构)
  - [10.8 获取一级分类](#108-获取一级分类)
  - [10.9 获取子分类](#109-获取子分类)
- [十二、属性模块 (Attribute)](#十二属性模块-attribute)
  - [11.1 获取分类属性](#111-获取分类属性)
  - [11.2 获取销售属性](#112-获取销售属性)
  - [11.3 获取基本属性](#113-获取基本属性)
  - [11.4 获取指定类型属性](#114-获取指定类型属性)
  - [11.5 获取SPU基本属性](#115-获取spu基本属性)
  - [11.6 获取SPU销售属性](#116-获取spu销售属性)
  - [11.7 获取SPU所有属性](#117-获取spu所有属性)
...
- [十五、文件模块 (File)](#十五文件模块-file)
  - [15.1 上传通用文件](#151-上传通用文件)
  - [15.2 上传图片](#152-上传图片)
  - [15.3 删除文件](#153-删除文件)
  - [15.4 下载文件](#154-下载文件)
  - [15.5 预览图片](#155-预览图片)
  - [15.6 获取文件URL](#156-获取文件url)
- [十六、店铺模块 (Store)](#十六店铺模块-store)
  - [16.1 新增店铺](#161-新增店铺)
  - [16.2 更新店铺信息](#162-更新店铺信息)
  - [16.3 获取店铺详情](#163-获取店铺详情)
  - [16.4 获取当前用户的店铺](#164-获取当前用户的店铺)
  - [16.5 获取店铺列表](#165-获取店铺列表)
  - [16.6 分页获取店铺列表](#166-分页获取店铺列表)
  - [16.7 更新店铺状态](#167-更新店铺状态)
- [十七、店铺管理员模块 (StoreAdmin)](#十七店铺管理员模块-storeadmin)
  - [17.1 新增店铺管理员](#171-新增店铺管理员)
  - [17.2 更新店铺管理员](#172-更新店铺管理员)
  - [17.3 删除店铺管理员](#173-删除店铺管理员)
  - [17.4 获取管理员详情](#174-获取管理员详情)
  - [17.5 获取店铺管理员列表](#175-获取店铺管理员列表)
  - [17.6 获取当前用户的管理员信息](#176-获取当前用户的管理员信息)
  - [17.7 更新管理员状态](#177-更新管理员状态)
- [十八、商家仪表盘模块 (StoreDashboard)](#十八商家仪表盘模块-storedashboard)
  - [18.1 获取销售 KPI 总览](#181-获取销售-kpi-总览)
  - [18.2 获取销售趋势（折线图）](#182-获取销售趋势折线图)
  - [18.3 获取商品销售排行](#183-获取商品销售排行)
- [十九、轮播图模块 (Banner)](#十九轮播图模块-banner)
  - [19.1 新增轮播图](#191-新增轮播图)
  - [19.2 编辑轮播图](#192-编辑轮播图)
  - [19.3 删除轮播图](#193-删除轮播图)
  - [19.4 启用轮播图](#194-启用轮播图)
  - [19.5 禁用轮播图](#195-禁用轮播图)
  - [19.6 获取轮播图列表（管理后台）](#196-获取轮播图列表管理后台)
  - [19.7 获取启用的轮播图列表（首页展示）](#197-获取启用的轮播图列表首页展示)
- [二十、属性管理模块 (AttributeManage)](#二十属性管理模块-attributemanage)
  - [20.1 新增属性](#201-新增属性)
  - [20.2 修改属性](#202-修改属性)
  - [20.3 删除属性](#203-删除属性)
  - [20.4 查询属性列表](#204-查询属性列表)
  - [20.5 查询属性详情](#205-查询属性详情)
  - [20.6 新增属性值](#206-新增属性值)
  - [20.7 修改属性值](#207-修改属性值)
  - [20.8 删除属性值](#208-删除属性值)
  - [20.9 查询属性值列表](#209-查询属性值列表)
- [二十一、分类-属性绑定管理模块 (CategoryAttributeManage)](#二十一分类-属性绑定管理模块-categoryattributemanage)
  - [21.1 获取分类已绑定的属性列表](#211-获取分类已绑定的属性列表)
  - [21.2 获取分类可绑定的属性列表](#212-获取分类可绑定的属性列表)
  - [21.3 绑定属性到分类](#213-绑定属性到分类)
  - [21.4 修改绑定排序](#214-修改绑定排序)
  - [21.5 解绑属性](#215-解绑属性)
- [二十二、用户管理模块 (UserManage)](#二十二用户管理模块-usermanage)
  - [22.1 将普通用户升级为商家](#221-将普通用户升级为商家)
...
| refundFromStatus | Integer | 退款来源状态: 2-待发货 3-待收货 4-已完成（取消退款时恢复至此状态） | `2` |
| isDeleted | Integer | 逻辑删除: 0-正常 1-已删除 | `0` |
| createdAt | DateTime | 创建时间 | `2026-05-15 10:00:00` |
| updatedAt | DateTime | 更新时间 | `2026-05-15 10:30:00` |

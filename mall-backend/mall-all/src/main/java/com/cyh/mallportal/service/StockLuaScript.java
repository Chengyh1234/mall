...
public class StockLuaScript {
    ...
    public StockLuaScript(RedisTemplate<String, String> redisTemplate) {
    ...
    public boolean freezeStock(Long skuId, int quantity) {
        ...
        Long result = redisTemplate.execute(freezeStockScript, keys, String.valueOf(quantity));
    ...
    public void confirmStock(Long skuId, int quantity) {
        ...
        redisTemplate.execute(confirmStockScript, keys, String.valueOf(quantity));
    }
    ...
    public void releaseStock(Long skuId, int quantity) {
        ...
        redisTemplate.execute(releaseStockScript, keys, String.valueOf(quantity));
    }
    ...
    public void cancelStock(Long skuId, int quantity) {
        ...
        redisTemplate.execute(cancelStockScript, keys, String.valueOf(quantity));
    }
}